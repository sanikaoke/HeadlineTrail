document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- API URLs ---
    const backendBaseUrl = 'https://headlinetrail-backend.onrender.com'; // Your Render backend URL
    ...
    function showArticleDetail(article) {
        ...
        // This uses the corrected variable 'original_url'
    ...
    monthSelect.addEventListener('change', () => {
        populateDayOptions();
        // Update day in filters before refetching
    ...
    function init() {
        ...
        loadingIndicator.style.display = 'block';
        // Fetch filter options first, then articles
