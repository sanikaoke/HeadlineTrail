...
def get_db_connection():
    ...
    # This uses the correct protocol for the client library
    url = TURSO_DATABASE_URL.replace("libsql://", "https://")
    # This uses the direct connection method that was failing previously. Let's revert to the URI method that is more standard.
    # The libsql-client with python's built-in sqlite3 should handle the connection type.
...
def format_date_for_display(date_obj):
    ...
    except Exception: # THE COLON WAS MISSING HERE
        return "Invalid Date"
...
def build_site():
    ...
    # --- Create a 'public' directory and save the final file ---
